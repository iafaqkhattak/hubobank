  ...
  return (
    <div className="container-fluid ">
      <div className="row vh-100">
            ...
            <div className="d-flex flex-row w-100 justify-content-rounded">
              <div className="logo+dec d-flex flex-row me-5 w-100">
                <div className="logo w-25 me-2">
                  <img className="w-100" src={DribbleLogo} alt="dribble logo" />
                </div>
                <div className="desc ">
        ...
        <div className="col-lg-3 d-flex flex-column align-items-center justify-content-center h-50 paypal-bg">
